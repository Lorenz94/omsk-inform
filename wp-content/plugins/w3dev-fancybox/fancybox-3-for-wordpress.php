...
Plugin URI: https://wordpress.org/plugins/w3dev-fancybox/
...
jQuery(function(){
	...
	<?php if(isset($settings['enableImage']) && $settings['enableImage'] == 'on') { ?>
	...
	<?php if(isset($settings['enableGallery']) && $settings['enableGallery'] == 'on') { ?>
	...
	<?php if(isset($settings['enableInline']) && $settings['enableInline'] == 'on') { ?>
...
add_action( 'wp_footer', 'fb3fw_init', 100 );
