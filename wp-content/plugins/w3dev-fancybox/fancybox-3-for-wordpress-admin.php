	...
	<div class="wrap">
		...
		<form method="post" action="options.php" id="options">
			...
			<table class="form-table">
				<tbody>
					<tr>
						<th scope="row"><?php _e('Enable Fancybox?', 'fb3fw'); ?></th>
						<td>
							<label for="enableImage">
								<input type="checkbox" name="fb3fw[enableImage]" id="enableImage" <?php if(isset($settings['enableImage']) && $settings['enableImage']) echo ' checked="yes"'; ?> />
								For Single Images &nbsp;&nbsp;
							</label>
							<label for="enableGallery">
								<input type="checkbox" name="fb3fw[enableGallery]" id="enableGallery" <?php if(isset($settings['enableGallery']) && $settings['enableGallery']) echo ' checked="yes"'; ?> />
								For Wordpress Galleries &nbsp;&nbsp;
							</label>
							<label for="enableInline">
								<input type="checkbox" name="fb3fw[enableInline]" id="enableInline" <?php if(isset($settings['enableInline']) && $settings['enableInline']) echo ' checked="yes"'; ?> />
								For Inline Content &nbsp;&nbsp;
							</label>
							<!-- IFRAME SUPPORT COMING SOON -->
							<!--
							<label for="enableIframe">
								<input type="checkbox" name="fb3fw[enableIframe]" id="enableIframe" <?php if(isset($settings['enableIframe']) && $settings['enableIframe']) echo ' checked="yes"'; ?> />
								For External Iframes &nbsp;&nbsp;
							</label>
							-->
							<p class="description">Select which fancyBox functionality should be enabled.</p>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							...
							<p class="description">Custom CSS class to add to each slide element</p>
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<p class="description">Custom CSS class to add to the fancyBox container</p>
						</td>
					</tr>
				</tbody>
			</table>
